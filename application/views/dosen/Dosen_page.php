...
<html lang="en">
  ...
  <!---->
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="row">
          <img src="<?=base_url()?>assets/imgdosen/<?php echo $foto;?>" class="col-sm-12">
          </div>
            ...
            <div class="col-sm-12">
               <div class="list-group">
                  <ul style="list-style-type: none;">
                   ...
                   <li class="list-group-item"><a href="<?=base_url()?>index.php/KP/getListBimbingan" style="color: #555; text-decoration: none; display: block;">List Bimbingan Mahasiswa</a></li>
