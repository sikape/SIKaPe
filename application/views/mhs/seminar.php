            ...
            <div class="col-sm-12">
              <div class="list-group">
                <ul style="list-style-type: none;">
                  ...
                  <li class="list-group-item"><a href="<?=base_url()?>index.php/KP/cetakbuktilaporan/<?php echo $nim;?>" style="color: #555; text-decoration: none; display: block;">Cetak Surat KP</a></li>
