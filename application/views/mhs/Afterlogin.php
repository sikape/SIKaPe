            ...
            <div class="col-sm-12">
               <div class="list-group">
                  ...
                  <li class="list-group-item"><a href="<?=base_url()?>index.php/KP/validasi_pembayaran_page" style="color: #555; text-decoration: none; display: block;">Daftar Seminar Kerja Praktik</a></li>
                   <li class="list-group-item"><a href="<?=base_url()?>index.php/KP/cetakpdf/<?php echo $nim;?>" target="_blank" style="color: #555; text-decoration: none; display: block;">Cetak Surat</a></li>
